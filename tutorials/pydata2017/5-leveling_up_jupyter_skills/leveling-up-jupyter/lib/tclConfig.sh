...
# installed.
TCL_PREFIX='/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/feedstock_root/build_artefacts/recipe_root_1480784158915/work/tcl8.5.19/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter/include'
...
# compiled.
TCL_SRC_DIR='/feedstock_root/build_artefacts/recipe_root_1480784158915/work/tcl8.5.19'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/feedstock_root/build_artefacts/recipe_root_1480784158915/work/tcl8.5.19/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/feedstock_root/build_artefacts/recipe_root_1480784158915/work/tcl8.5.19/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/donal/cyberdyne/pydata2017/leveling_up_jupyter_skills/leveling-up-jupyter/lib/libtclstub8.5.a'
